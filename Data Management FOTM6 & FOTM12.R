library(readxl)
Copy_of_MASTER_CLEAN_DATA_FOTM <- read_excel("Desktop/Copy of MASTER CLEAN DATA FOTM.xlsx", 
                                             sheet = "All 12-Month Secondary")
View(Copy_of_MASTER_CLEAN_DATA_FOTM)
...
names(FOTM_12)[names(FOTM_12)== "HEALTH_PHYS_0_TEXT"] <- "HEALTH_PHYS"
names(FOTM_12)[names(FOTM_12)== "HEALTH_MENTAL_0_TEXT"] <- "HEALTH_MENTAL"

################################################################################
# Labeling Retirement and Employment as NA
################################################################################

FOTM_12$EMPLOYED[FOTM_12$RETIRED == "YES" & FOTM_12$EMPLOYED == "NO"] <- "Retired"
FOTM_12$RETIRED[FOTM_12$EMPLOYED == "YES" & FOTM_12$RETIRED == "NO"] <- "Employed"
...
FOTM_12_Sub_1 <- FOTM_12_Sub_1[,-18]
View(FOTM_12_Sub_1)
...
ggplot(data=FOTM_12_Sub_1)+geom_bar(aes(x=factor(Age)))+ggtitle("Age")

# Create Categories

FOTM_12_Sub_1$Age_Groups[FOTM_12_Sub_1$Age >= 26 & FOTM_12_Sub_1$Age < 63] <- "26-63 Years"
FOTM_12_Sub_1$Age_Groups[FOTM_12_Sub_1$Age >= 63 & FOTM_12_Sub_1$Age < 71] <- "63-71 Years"
FOTM_12_Sub_1$Age_Groups[FOTM_12_Sub_1$Age >= 71 & FOTM_12_Sub_1$Age < 78] <- "71-78 Years"
FOTM_12_Sub_1$Age_Groups[FOTM_12_Sub_1$Age >= 78] <- "Over 78"

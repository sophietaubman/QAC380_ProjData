...
FOTM_BL <- MASTER_CLEAN_DATA_FOTM[,c("Loyalty card number","Age", "GENDER",
...
names(FOTM_BL)[names(FOTM_BL)== "HEALTH_PHYS_0_TEXT"] <- "HEALTH_PHYS"
names(FOTM_BL)[names(FOTM_BL)== "HEALTH_MENTAL_0_TEXT"] <- "HEALTH_MENTAL"
